...
<head>
    ...
    <title>Edit Product | Kenyan Inventory</title>
        ...
        <main class="flex-grow">
            <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center mb-8">
                    <div>
                        <h1 class="text-2xl font-bold text-kenya-black font-display">
                            <i class="fas fa-edit mr-2 text-kenya-green"></i>
                            Edit Product
                        </h1>
                ...
                <div class="bg-kenya-white rounded-lg shadow-md card-shadow overflow-hidden">
                    <form action="edit_product.php?id=<?php echo $product_id; ?>" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <?php if (!empty($product['image_path'])): ?>
                                    <img src="<?php echo htmlspecialchars($product['image_path']); ?>" alt="Current Product Image" class="product-image-preview mb-2">
                                    <p class="text-xs text-gray-500"><?php echo basename($product['image_path']); ?></p>
                                <?php else: ?>
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="3"
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-kenya-green focus:ring focus:ring-kenya-green focus:ring-opacity-50 p-3 border"
                                   placeholder="Product details and specifications"><?php echo htmlspecialchars($product['description']); ?></textarea>
                        </div>
