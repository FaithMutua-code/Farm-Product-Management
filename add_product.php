...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($name) || empty($price) || empty($quantity)) {
        ...
        // Insert new product
        $sql = "INSERT INTO products (name, description, price, quantity, staff_id) 
        ...
        <main class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            <div class="px-4 py-6 sm:px-0">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-semibold text-gray-900">Add New Product</h2>
                    ...
                    <form action="add_product.php" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" rows="3"
                                   class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"><?php echo isset($description) ? htmlspecialchars($description) : ''; ?></textarea>
                        </div>
